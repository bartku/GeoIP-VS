...
typedef enum {
	...
	GEOIP_DOMAIN_EDITION      = 11,
        GEOIP_COUNTRY_EDITION_V6  = 12,                /* should be unused, IPv6 support removed */
        ...
        GEOIP_LARGE_COUNTRY_EDITION_V6 = 18,           /* should be unused, IPv6 support removed */
        ...
        GEOIP_ASNUM_EDITION_V6         = 21,           /* should be unused, IPv6 support removed */
        GEOIP_ISP_EDITION_V6           = 22,           /* should be unused, IPv6 support removed */
        GEOIP_ORG_EDITION_V6           = 23,           /* should be unused, IPv6 support removed */
        GEOIP_DOMAIN_EDITION_V6        = 24,           /* should be unused, IPv6 support removed */
        GEOIP_LOCATIONA_EDITION_V6     = 25,           /* should be unused, IPv6 support removed */
        GEOIP_REGISTRAR_EDITION        = 26,
        GEOIP_REGISTRAR_EDITION_V6     = 27,           /* should be unused, IPv6 support removed */
        GEOIP_USERTYPE_EDITION         = 28,
        GEOIP_USERTYPE_EDITION_V6      = 29,           /* should be unused, IPv6 support removed */
        GEOIP_CITY_EDITION_REV1_V6     = 30,           /* should be unused, IPv6 support removed */
        GEOIP_CITY_EDITION_REV0_V6     = 31,           /* should be unused, IPv6 support removed */
        GEOIP_NETSPEED_EDITION_REV1    = 32, 
        GEOIP_NETSPEED_EDITION_REV1_V6 = 33            /* should be unused, IPv6 support removed */
} GeoIPDBTypes;
